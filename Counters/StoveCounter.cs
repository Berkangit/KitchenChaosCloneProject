...
public class StoveCounter : BaseCounter , IHasProgress
{
    ...
    private FryingRecipeSO GetFryingRecipeSOWithInput(KitchenObjectsScriptableObject inputKitchenObjectSO)
    {
    ...
    private BurningRecipeSO GetBurningRecipeSOWithInput(KitchenObjectsScriptableObject inputKitchenObjectSO)
    {
